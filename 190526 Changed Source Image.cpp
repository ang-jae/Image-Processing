...
void main()
{
	...
	*/
	...
	DecodingImage(input_image, height, width, height, width, decoded_image2);
	Blocks3 = EncodingImage(decoded_image2);
	DecodingImage(input_image, height, width, height, width, decoded_image3);
	Blocks4 = EncodingImage(decoded_image3);
	DecodingImage(input_image, height, width, height, width, decoded_image4);
	Blocks5 = EncodingImage(decoded_image4);
	DecodingImage(input_image, height, width, height, width, decoded_image5);
