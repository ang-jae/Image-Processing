...
void main()
{
	...
	//DecodingImage(input_image, height, width, height, width, decoded_image);
#if 0
	Blocks_Scaled = EncodingImageWithScaling();
	DecodingImageWithScaling(input_image, height, width, height, width, decoded_image_scaling);

	Blocks_GT = EncodingImageWithGeometricTransform();
	DecodingImageWithGeometricTransform(input_image, height, width, height, width, decoded_image_gt);
