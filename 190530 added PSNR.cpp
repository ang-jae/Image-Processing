...
Block**EncodingImage(int**image_input)
{
	for (int i = 0; i < height; i += N)
	{
		for (int j = 0; j < width; j += N)
...
Block**EncodingImageWithScaling()
{
	...
	return Blocks_Scaled;
}

Block**EncodingImageTotal()
{
...
void main()
{
	...
	//for (int i = 0; i < 999; i++) DecodingImageWithScaling(decoded_image_scaling, height, width, height, width, decoded_image_scaling);
	//for (int i = 0; i < 999; i++) DecodingImageWithGeometricTransform(decoded_image_gt, height, width, height, width, decoded_image_gt);

	ImageShow((char*)"NormalX1000", decoded_image, height, width);
	//ImageShow((char*)"ScalingX1000", decoded_image_scaling, height, width);
	//ImageShow((char*)"GTX1000", decoded_image_gt, height, width);

	/*
	Blocks2 = EncodingImage(decoded_image);
	DecodingImage(decoded_image, height, width, height, width, decoded_image2);
	Blocks3 = EncodingImage(decoded_image2);
	DecodingImage(decoded_image2, height, width, height, width, decoded_image3);
	Blocks4 = EncodingImage(decoded_image3);
	DecodingImage(decoded_image3, height, width, height, width, decoded_image4);
	Blocks5 = EncodingImage(decoded_image4);
	DecodingImage(decoded_image4, height, width, height, width, decoded_image5);


	ImageShow((char*)"1Coding", decoded_image, height, width);
	ImageShow((char*)"2Coding", decoded_image2, height, width);
	ImageShow((char*)"3Coding", decoded_image3, height, width);
	ImageShow((char*)"4Coding", decoded_image4, height, width);
	ImageShow((char*)"5Coding", decoded_image5, height, width);
	*/
