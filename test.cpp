...
void Rendering2D(POS3D p1, POS3D p2, POS3D p3, int**image, int height, int width)
{
	float** A = (float**)FloatAlloc2(3, 3);
	SetMatrixA(width, height, A);
	POS3D v21, v31;
...
void main()
{
	...
	POS3D p1, p2, p3;
	p1 = SetPOS3D(100, 200, 600);
	p2 = SetPOS3D(300, 200, 600);
	p3 = SetPOS3D(100, 400, 600);
	Rendering2D(p1, p2, p3, image, height, width);
